          ...
          <.form for={@form} phx-change="validate_issue" phx-submit="save_issue">
            <div class="flex flex-col gap-3">
              ...
              <div class="flex gap-3">
                ...
                <select name="issue[priority]" class="select select-sm select-bordered">
                  <option :for={p <- 0..4} value={p} selected={to_string(@form[:priority].value) == to_string(p)}>
                    P{p}
                  </option>
                </select>
              </div>
    ...
    <div>
      ...
      >
        ...
        <div class="flex-1 min-w-0 flex items-center gap-2" phx-click="select_issue" phx-value-id={@issue.id}>
          ...
          <span :if={@issue.priority > 0} class="badge badge-xs badge-ghost flex-shrink-0">
            P{@issue.priority}
          </span>
        </div>
      ...
      <div class="flex items-start justify-between mb-3">
        <div>
          <div class="flex items-center gap-2 mb-1">
            ...
            <span :if={@issue.priority > 0} class="badge badge-sm badge-ghost">P{@issue.priority}</span>
          </div>
