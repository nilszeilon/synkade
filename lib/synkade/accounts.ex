defmodule Synkade.Accounts do
  ...
  alias Synkade.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Synkade.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Synkade.Accounts.User.password_changeset/3` for a list of supported options.
