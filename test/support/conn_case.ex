defmodule SynkadeWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use SynkadeWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      @endpoint SynkadeWeb.Endpoint

      use SynkadeWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import SynkadeWeb.ConnCase
    end
  end

  setup tags do
    Synkade.DataCase.setup_sandbox(tags)
  ...
  def log_in_user(conn, user, opts \\ []) do
    token = Synkade.Accounts.generate_user_session_token(user)
  ...
  defp maybe_set_token_authenticated_at(token, authenticated_at) do
    Synkade.AccountsFixtures.override_token_authenticated_at(token, authenticated_at)
  end
end
