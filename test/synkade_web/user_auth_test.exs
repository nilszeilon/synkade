defmodule SynkadeWeb.UserAuthTest do
  use SynkadeWeb.ConnCase

  alias Synkade.Accounts
  alias Synkade.Accounts.Scope
  alias SynkadeWeb.UserAuth

  import Synkade.AccountsFixtures

  @remember_me_cookie "_synkade_web_user_remember_me"
  @remember_me_cookie_max_age 60 * 60 * 24 * 14

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, SynkadeWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
